...
import nh_c1_mayu_1 from '../assets/natsuhanabi/c1-mayu-1.jpg'
import nh_c1_sapi_1 from '../assets/natsuhanabi/c1-sapi-1.jpg'
import nh_c2_kyon_1 from '../assets/natsuhanabi/c2-kyon-1.jpg'
import nh_c2_mayu_1 from '../assets/natsuhanabi/c2-mayu-1.jpg'
import nh_c2_nene_1 from '../assets/natsuhanabi/c2-nene-1.jpg'
import nh_c2_sapi_1 from '../assets/natsuhanabi/c2-sapi-1.jpg'
import nh_c2_yaka_1 from '../assets/natsuhanabi/c2-yaka-1.jpg'
import nh_c2_yuna_1 from '../assets/natsuhanabi/c2-yuna-1.jpg'
import nh_c3_mana_1 from '../assets/natsuhanabi/c3-mana-1.jpg'
import nh_c3_mana_2 from '../assets/natsuhanabi/c3-mana-2.jpg'
import nh_c3_yaka_1 from '../assets/natsuhanabi/c3-yaka-1.jpg'
import nh_c3_yaka_2 from '../assets/natsuhanabi/c3-yaka-2.jpg'
import nh_i1_katsuura from '../assets/natsuhanabi/i1-katsuura.jpg'
import nh_i1_rail from '../assets/natsuhanabi/i1-rail.jpg'
import nh_i2_kyon_1 from '../assets/natsuhanabi/i2-kyon-1.jpg'
import nh_i2_nene_1 from '../assets/natsuhanabi/i2-nene-1.jpg'
import nh_i2_yuna_1 from '../assets/natsuhanabi/i2-yuna-1.jpg'
import nh_intro_coast from '../assets/natsuhanabi/intro-coast.jpg'
import nh_intro_kyon from '../assets/natsuhanabi/intro-kyon.jpg'
import nh_intro_mana from '../assets/natsuhanabi/intro-mana.jpg'
import nh_intro_mayu from '../assets/natsuhanabi/intro-mayu.jpg'
import nh_intro_nene from '../assets/natsuhanabi/intro-nene.jpg'
import nh_intro_sapi from '../assets/natsuhanabi/intro-sapi.jpg'
import nh_intro_turbine from '../assets/natsuhanabi/intro-turbine.jpg'
import nh_intro_yaka from '../assets/natsuhanabi/intro-yaka.jpg'
import nh_intro_yuna from '../assets/natsuhanabi/intro-yuna.jpg'
import nh_intro_yuri from '../assets/natsuhanabi/intro-yuri.jpg'
import nh_v1_mana_1 from '../assets/natsuhanabi/v1-mana-1.jpg'
import nh_v1_mana_2 from '../assets/natsuhanabi/v1-mana-2.jpg'
import nh_v1_nene_1 from '../assets/natsuhanabi/v1-nene-1.jpg'
import nh_v1_yaka_1 from '../assets/natsuhanabi/v1-yaka-1.jpg'
import nh_v1_yaka_2 from '../assets/natsuhanabi/v1-yaka-2.jpg'
import nh_v1_yuna_1 from '../assets/natsuhanabi/v1-yuna-1.jpg'
import nh_v1_yuri_1 from '../assets/natsuhanabi/v1-yuri-1.jpg'
import nh_v1_yuri_2 from '../assets/natsuhanabi/v1-yuri-2.jpg'
import nh_v2_mayu_1 from '../assets/natsuhanabi/v2-mayu-1.jpg'
import nh_v2_mayu_2 from '../assets/natsuhanabi/v2-mayu-2.jpg'
import nh_v2_sapi_1 from '../assets/natsuhanabi/v2-sapi-1.jpg'
import nh_v2_sapi_2 from '../assets/natsuhanabi/v2-sapi-2.jpg'
import nh_v2_yaka_1 from '../assets/natsuhanabi/v2-yaka-1.jpg'
import nh_v2_yuna_1 from '../assets/natsuhanabi/v2-yuna-1.jpg'
import nh_v2_yuri_1 from '../assets/natsuhanabi/v2-yuri-1.jpg'
import nh_v2_yuri_2 from '../assets/natsuhanabi/v2-yuri-2.jpg'

import ds_kyon from '../assets/denesupi/kyon.jpg'
import ds_mana from '../assets/denesupi/mana.jpg'
import ds_mayu from '../assets/denesupi/mayu.jpg'
import ds_nene from '../assets/denesupi/nene.jpg'
import ds_sapi from '../assets/denesupi/sapi.jpg'
import ds_yaka from '../assets/denesupi/yaka.jpg'
...
import rs_4 from '../assets/restage/4.jpg'
import rs_5 from '../assets/restage/5.jpg'
import rs_6 from '../assets/restage/6.jpg'
import rs_7 from '../assets/restage/7.jpg'
import rs_8 from '../assets/restage/8.jpg'
...
const SIGURURI_SCENES = [
  ...
  { title: 'アイキャッチ 2-2 (館山駅)', src: sig_2_2 },
  { title: 'アイキャッチ 3-1 (館山城)', src: sig_3_1 },
  { title: 'アイキャッチ 3-2 (海ほたる)', src: sig_3_2 },
  { title: 'アイキャッチ 4-2 (沖ノ島水浴場)', src: sig_4_2 },
  { title: 'アイキャッチ 5-1 (大福寺)', src: sig_5_1 },
  { title: 'アイキャッチ 5-2 (たてやま温泉千里の風)', src: sig_5_2 },
  { title: 'アイキャッチ 6-1 (洲埼灯台)', src: sig_6_1 },
  { title: 'アイキャッチ 6-2 (館山いちご狩りセンター)', src: sig_6_2 },
  { title: 'アイキャッチ 8-1 (大房岬自然公園砲台跡)', src: sig_8_1 },
  { title: 'アイキャッチ 8-2 (ひふみ養蜂園)', src: sig_8_2 },
  { title: 'アイキャッチ 9-1 (赤山地下壕跡)', src: sig_9_1 },
  { title: 'アイキャッチ 9-2 (里見茶屋)', src: sig_9_2 },
...
const NATSU_HANABI_SCENES = [
  { title: 'イントロ ゆりにゃ (松の家)', src: nh_intro_yuri },
  { title: 'イントロ ねーね (鵜原)', src: nh_intro_nene },
  { title: 'イントロ きょん (覚翁寺)', src: nh_intro_kyon },
  { title: 'イントロ ゆーな (遠見岬神社)', src: nh_intro_yuna },
  { title: 'イントロ やかん (椿公園)', src: nh_intro_yaka },
  { title: 'イントロ さっぴ (松の家)', src: nh_intro_sapi },
  { title: 'イントロ まゆゆん (勝浦海中公園)', src: nh_intro_mayu },
  { title: 'イントロ まなてぃ (八幡岬公園)', src: nh_intro_mana },
  { title: 'イントロ 風車 (勝浦海中公園)', src: nh_intro_turbine },
  { title: 'イントロ 海岸 (八幡岬公園)', src: nh_intro_coast },
  { title: '1A やかん 引き (上総東駅)', src: nh_v1_yaka_1 },
  { title: '1A やかん アップ (上総東駅)', src: nh_v1_yaka_2 },
  { title: '1A ゆーな (遠見岬神社)', src: nh_v1_yuna_1 },
  { title: '1A ゆりにゃ 引き (松の湯)', src: nh_v1_yuri_1 },
  { title: '1A ゆりにゃ アップ (松の湯)', src: nh_v1_yuri_2 },
  { title: '1B まなてぃ 引き (港こおり屋)', src: nh_v1_mana_1 },
  { title: '1B まなてぃ アップ (港こおり屋)', src: nh_v1_mana_2 },
  { title: '1B ねーね (住広はきもの店)', src: nh_v1_nene_1 },
  { title: '1サビ まゆゆん (八幡岬公園)', src: nh_c1_mayu_1 },
  { title: '1サビ さっぴ (勝浦)', src: nh_c1_sapi_1 },
  { title: '1サビ きょん 引き (覚翁寺)', src: nh_c1_kyon_1 },
  { title: '1サビ きょん アップ (覚翁寺)', src: nh_c1_kyon_2 },
  { title: '間奏 勝浦 (遠見岬神社)', src: nh_i1_katsuura },
  { title: '間奏 鉄道 (上総東駅)', src: nh_i1_rail },
  { title: '2A さっぴ 引き (勝浦海中公園)', src: nh_v2_sapi_1 },
  { title: '2A さっぴ アップ (勝浦海中公園)', src: nh_v2_sapi_2 },
  { title: '2A まゆゆん アップ (勝浦海中公園)', src: nh_v2_mayu_1 },
  { title: '2A まゆゆん 引き (勝浦海中公園)', src: nh_v2_mayu_2 },
  { title: '2B ゆーな (遠見岬神社)', src: nh_v2_yuna_1 },
  { title: '2B やかん (?)', src: nh_v2_yaka_1 },
  { title: '2B ゆりにゃ (遠見岬神社)', src: nh_v2_yuri_1 },
  { title: '2B ゆりにゃ (遠見岬神社)', src: nh_v2_yuri_2 },
  { title: '2サビ ゆーな (遠見岬神社)', src: nh_c2_yuna_1 },
  { title: '2サビ やかん (椿公園)', src: nh_c2_yaka_1 },
  { title: '2サビ きょん (覚翁寺)', src: nh_c2_kyon_1 },
  { title: '2サビ ねーね (遠見岬神社)', src: nh_c2_nene_1 },
  { title: '2サビ まゆゆん (勝浦海中公園)', src: nh_c2_mayu_1 },
  { title: '2サビ さっぴ (?)', src: nh_c2_sapi_1 },
  { title: '間奏 ゆーな (八坂神社一ノ鳥居)', src: nh_i2_yuna_1 },
  { title: 'Cメロ きょん (覚翁寺)', src: nh_i2_kyon_1 },
  { title: 'Cメロ ねーね (鵜原)', src: nh_i2_nene_1 },
  { title: '落ちサビ やかん 引き (新田)', src: nh_c3_yaka_1 },
  { title: '落ちサビ やかん アップ (新田)', src: nh_c3_yaka_2 },
  { title: 'ラスサビ まなてぃ (八幡岬公園)', src: nh_c3_mana_1 },
  { title: 'ラスサビ まなてぃ (八幡岬公園)', src: nh_c3_mana_2 },
];

const DENESUPI_SCENES = [
  { title: 'さっぴ', src: ds_sapi },
  { title: 'やかん', src: ds_yaka },
  { title: 'ゆりにゃ', src: ds_yuri },
  { title: 'ゆーな', src: ds_yuna },
  { title: 'ねーね', src: ds_nene },
  { title: 'まゆゆん', src: ds_mayu },
  { title: 'まなてぃ', src: ds_mana },
